...
public class GoodSelectController {
    ...
    public ModelAndView goodSelect(@PathVariable("good_type") String goodType, @PathVariable("user_id") String user_id){
        ...
        List<Map<Object, Object>> goodList = weShopService.queryPlanListByPage(ctlgArray, 1, 5);
    ...
    public ModelAndView queryGoodListAjax(){
        //返回数据表格子页面
        ModelAndView mav = new ModelAndView("phoneGoodSelectSub.ftl"); 
        //从数据库获取信息赋值
