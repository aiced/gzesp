 ...
 * @since [产品/模块版本] （可选）
 */
public class RespBindQryHandler implements IDealUnionPayResp {
    ...
    public RespBindQryHandler(Map<String, String> respMap, UnionPayService unionPayService){
