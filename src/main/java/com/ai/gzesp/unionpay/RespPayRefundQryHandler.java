 ...
 * @since [产品/模块版本] （可选）
 */
public class RespPayRefundQryHandler implements IDealUnionPayResp {
    ...
    public RespPayRefundQryHandler(Map<String, String> respMap, UnionPayService unionPayService){
