...
import com.ai.wxpay.service.ScanPayQueryService;
import com.ai.wxpay.service.ScanPayService;
...
public class WXPay {
     ...
     */
    public static void initSDKConfiguration(String key,String appID,String mchID,String deviceInfo,String sdbMchID,String certLocalPath,String certPassword){
        Configure.setKey(key);
        Configure.setAppID(appID);
        Configure.setMchID(mchID);
        Configure.setDeviceInfo(deviceInfo);
