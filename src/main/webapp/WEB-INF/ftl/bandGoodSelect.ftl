...
<html lang="zh-cn">
  ...
  <body>
    ...
    <#list userCheckReq_Res.productList as item>
	    <div class="container-fluid" style="background-color:#ffffff;margin:10px;padding-left: 20px;" onclick="doClick(${item.productCode});">
	    	<div class="row">
	...
	<input type="hidden" id="hide_bandAcct1" name="hide_bandAcct1" value=${userCheckReq_Res.CustName}>         
