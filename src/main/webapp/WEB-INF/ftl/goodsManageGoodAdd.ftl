 ...
 <body>
	...
	<div style="background-color:white;width:100%;height:32px;margin-bottom:0px;position:relative;">
		...
		<div style="float:right;width:150px;height:30px">
			 <a style="width:60px;height:30px;display:block;text-align:center;float:left;line-height:30px;margin-left:20px;font-size:15px;color:#818181" onclick="showFlowView(); return false;">筛选</a>
			 <img src="${resRoot}/image/goodsManager/xiaLaSanJiao.png" style="width:10px;height:10px;float:left;margin-left:0px;margin-top:10px;"></img>
		</div>
		...
		<div id="searchMark" style="float:left;width:100%;height:600px;top:31px;display:none;position:absolute;margin:auto;z-index:100;">
			    	<div id="searchMarkSub" style="background-color:white;width:260px;height:180px;margin:auto;;border:1px solid #A6A6A6;">
						...
						<a style="color:#7E7D7D;width:60px;height:20px ;line-height:20px; float:left;display: block;text-align:center;margin-left:5px;margin-top:10px;border:1px solid #7E7D7D;font-size:11px;" onclick="setTagCondition(4,9); return false;">合约购机</a>	
						<a style="color:#7E7D7D;width:60px;height:20px ;line-height:20px; float:left;display:block;text-align:center;margin:auto;margin-top:10px;margin-left:35px;border:1px solid #7E7D7D;font-size:11px;" onclick="setTagCondition(6,11); return false;">上网卡</a>	
						<a style="color:#7E7D7D;width:60px;height:20px ;line-height:20px; float:right;display: block;text-align:center;margin-right:5px;margin-top:10px;border:1px solid #7E7D7D;font-size:11px;" onclick="setTagCondition(7,12); return false;">宽带续约</a>	
						
						<a style="color:#7E7D7D;width:65px;height:20px ;line-height:20px; float:left;display: block;text-align:center;margin-left:5px;margin-top:20px;border:1px solid #7E7D7D;font-size:11px;" onclick="setTagCondition(8,13); return false;">流量包</a>	
