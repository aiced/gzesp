				...
				<tr style=" height:100px;">
					...
					<td class = "td_second">
							<a id="itemSelected_${info_index}" style="background-color:white;display:block; width:100%;height:70px;margin-top:15px;margin-bottom:15px" onclick='itemClick(${info.goodsId})'>
         	     				<img src='${info.photoLinks}' onerror="this.src='http://s8.51cto.com/wyfs02/M00/12/34/wKiom1L9bvvxg3qRAAEf2nVs_4E709.png'"   style="display:block;width:75px;height:50px;float:left;margin-left:10px;margin-top:10px">
