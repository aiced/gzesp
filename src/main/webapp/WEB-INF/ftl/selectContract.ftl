...
<html lang="zh-cn">
  ...
  <body>
    ...
    <div class="container-fluid" style="background-color:#21292C;margin-top:1px;padding:3px">
	    <div class="row" >
		    <div class="col-xs-6" style="border-right:solid 1px #f4f4f4;" >
 		     	<button style="width:100%;height:36px;display: block;text-align:center;background-color:#21292C;color:white" class="btn dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true"> 
	           ...
	           <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1" style="margin:-1px 0px 0px 2px;background-color:#21292C;">
	           			<#if (pkgList?? && pkgList?size>0)>
		        	  	<#list pkgList as item>  
							<li role="presentation"  onclick="javascript:showActPkg(this)">
						  		 <a style=" line-height:1;vertical-align:middle;color:white" role="menuitem" tabindex="-1" href="javascript:void(0)">${item.name}</a>
	        ...
	        <div class="col-xs-6"  style="line-height:1;padding-left:2px">
	         	<button style="padding:2px;margin-top:3px;width:100%;height:36px;display: block;text-align:center;background-color:#21292C;color:white" class="btn dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-expanded="true"> 
...
<!-- 			 	 </button> -->
	        		<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu2" style="margin:0px 0px 0px -2px;background-color:#21292C;">
