	    ...
	    <div>
	        ...
	        <div class="list-group">
	        	...
	        	<#if (usertype=='1')>
	  	            ...
	  	            <a href="/esp/pay/insteadPay/${userid}/1351432881852603" class="list-group-item">代客下单<span class="list_gou"><img src="${resRoot}/image/shopHome/jiantou.png" width="9" height="15"></span></a>
